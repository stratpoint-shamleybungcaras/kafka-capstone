...
class EcommerceDataGenerator:
    """
    Generates complex e-commerce data, utilizing nested records, arrays, 
    booleans, and floats to test schema constraints.
    """
    ...
    def generate_user(self) -> Dict[str, Any]:
        """Explores Booleans and Nested Preferences."""
        return {
            "user_id": self.get_user_id(),
            "email": fake.email(),
            "is_active": True, # Boolean testing
            "preferences": { # Nested Record testing
    ...
    def generate_order(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "user_id": self.get_user_id(),
            "items": items, # Array of Records testing
    ...
    def generate_payment(self, order_id: str, amount: float) -> Dict[str, Any]:
        """Explores Optional/Nullable fields and Risk Scoring."""
        ...
        return {
            ...
            "risk_score": round(random.uniform(0.0, 1.0), 2), # Float testing
            # Example of a field that might be empty/null if it's not a credit card
